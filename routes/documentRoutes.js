...
const { uploadDocument, assignSigners, getUserDocuments, signDocument, downloadDocument, getAssignedDocuments, updateDocument } = require('../controllers/documentController');
...
router.post('/update-document/:documentId', protect,  upload.single('document'), updateDocument);
